...
import pandas as pd
import requests
from .pipeline_deforum_animation import DeforumAnimKeys, LooperAnimKeys
from .animation_helpers import ControlNetKeys
from deforum.utils.rich_console import console
from deforum.utils.string_utils import tickOrCross
...
class ParseqAdapter():
    def __init__(self, parseq_args, anim_args, video_args, controlnet_args, loop_args, freeu_arg=None, kohya_hrfix_keys=None, mute=False):
        ...
        self.anim_keys = ParseqAnimKeysDecorator(self, DeforumAnimKeys(anim_args))
